...
#SBATCH --mem=32G # Request 32G per node
#SBATCH --constraint=centos7 # Use only centos7 CPUs
#SBATCH --partition=sched_mit_sloan_batch
#SBATCH --time=2-00:00 # max time for the sched_mit_sloan_batch partition is 4 days
...
python ../scripts/run_cv/run_cv.py $1 $2 $3 $4
